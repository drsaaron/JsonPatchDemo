...
public class DataInitializerCommandLineRunner implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        List<PersonData> people = List.of(
                new PersonData(null, "Scott", LocalDate.parse("2000-01-01"), null),
                new PersonData(null, "Henry", LocalDate.parse("1480-10-01"), null),
                new PersonData(null, "Lancelot", LocalDate.parse("1210-06-20"), null)
        );
